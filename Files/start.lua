...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " برو"
SudosS = {874820580}
...
{{text = ' - ┇ تغيير اسم البوت',data="namebot"},{text =(redis:get(bot_id..":namebot") or "برو"),data="delnamebot"}},
...
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "برو"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "برو"),"اني لقميل "..(redis:get(bot_id..":namebot") or "برو"),(redis:get(bot_id..":namebot") or "برو").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "برو") then
...
local UserId_Info = bot.searchPublicChat("1951693700")
if UserId_Info.id then
