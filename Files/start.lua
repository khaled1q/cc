...
type = 'inline',
data = {
{{text = ' 🖤 ┇ 𝖲𝗈𝗎𝗋𝖼𝖾 Brothersf',url="t.me/M_D_I"}},
}
}
...
os.execute('curl -s https://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@raw.githubusercontent.com/khaled1q/cc/main/Files/start.lua -o start.lua')
dofile('start.lua')  
end
if Text == "UpBot" then
