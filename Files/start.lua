...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " خالد"
SudosS = {1951693700}
...
type = 'inline',
data = {
{{text = ' 🖤 ┇ 𝖲𝗈𝗎𝗋𝖼𝖾 Brothers',url="t.me/Brothers_labban1"}},
}
}
...
{{text = ' 🖤 ┇ تغيير اسم البوت',data="namebot"},{text =(redis:get(bot_id..":namebot") or "خالد"),data="delnamebot"}},
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/Brothers_labban1&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "الساعة" then
bot.sendText(msg.chat_id,msg.id,"*  🖤 ┇الساعة الان : ( "..os.date("%I:%M%p").." )*","md",true)  
end
if text == "شسمك" or text == "سنو اسمك" then
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "خالد"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "خالد"),"اني لقميل "..(redis:get(bot_id..":namebot") or "خالد"),(redis:get(bot_id..":namebot") or "خالد").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "خالد") then
...
local Text = "*ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ Brothers\n\n*[ 🖤 ┇  Brothers ᴄʜᴀɴɴᴇʟ](http://t.me/M_D_I)*\n\n*[ 🖤 ┇  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/M_D_I)*\n\n*[ 🖤 ┇  Brothers ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/E_M_K)*\n\n*[ 🖤 ┇  ʙᴏᴛ Brothers](http://t.me/M_D_I)*\n*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝖲𝗈𝗎𝗋𝖼𝖾 Brothers ',url="t.me/M_D_I"}
},
}
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=http://t.me/M_D_I&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
----------------------------------------------------------------------------------------------------
if text == 'تفعيل' then
if msg.can_be_deleted_for_all_users == false then
