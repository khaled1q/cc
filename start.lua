...
if text == "/start" then 
local bl = '*◾أهلا بك في صانع بوتات الحماية 👋🏻 ،\n\n◽البوت مقدم من قناة »* [. 𝖲𝗈𝗎𝗋𝖼𝖾 Brothers Team >](t.me/yousef_labban1) \n\n*◾يمكنك الان صنع بوت واحد فقط من صانع البوتات\n\n     عليك استخدام اوامر التحكم اسفل وبدء الانشاء🔻\n⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯*\n[⚙️꒐ Gruop The Suport Maker .](https://t.me/M_D_I)'
...
return bot.sendText(msg.chat_id,msg.id,'*⚠️꒐ عذرأ ، البوت مدفوع للأشتراك                                       راسل المطور : - @E_M_K -*', 'md', false, false, false, false, reply_markun)
end
end
